...
- Search matches page title, host and URL. Entries are ordered newest first and grouped by local calendar date.
...
- Private tabs never reach the repository. Link Peek remains read-only and does not record visits.
