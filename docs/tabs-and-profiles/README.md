...
| Writable synced device profiles | [`../sync/app-integration.md`](../sync/app-integration.md) | Runtime profile/tab projections reuse native WebView interaction but never enter `BrowserSessionStore` |
