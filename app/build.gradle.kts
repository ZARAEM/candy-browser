...
val debugApplicationIdSuffix =
    providers.gradleProperty("candy.debugApplicationIdSuffix").orElse(".debug")
val debugAppLabel = providers.gradleProperty("candy.debugAppLabel").orElse("Candy Browser Debug")
